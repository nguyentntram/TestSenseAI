...
import { GitBranch, GitPullRequest, Database, FlaskConical, Settings, Info, ArrowRight } from 'lucide-react'
  ...
  return (
    <div>
      <div className="mb-3 flex items-center justify-between">
        <p className="text-sm text-slate-500">{project.pullRequests.length} pull requests</p>
