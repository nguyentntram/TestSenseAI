...
// `memoryCount`, `openPullRequests`, and `lastSyncedAt` come from Han's PR
// ingestion and Trung's memory features respectively — the real backend
// schema (backend/database) doesn't populate them yet, only the mock
// dataset does. Render them only when present so this card works with both.
